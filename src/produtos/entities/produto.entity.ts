...
export class Produto {
  ...
  @ManyToMany(() => Arquivo, (arquivo) => arquivo.produtos, { onDelete: "RESTRICT", nullable: false })
  @JoinTable({name:"galeria"})
  arquivos: Arquivo[];

  @ManyToOne(() => Categoria, (categoria) => categoria.produtos, { onDelete: "CASCADE", nullable: false })
  @JoinColumn({ name: "id_categoria" })
  categoria: Categoria;

  @ManyToMany(() => Tamanho, (tamanho) => tamanho.produto, { onDelete: "RESTRICT", nullable: false })
  @JoinTable({name:"tamanhos_produtos"})
  tamanhos: Tamanho[]

  @OneToMany(() => Venda, (venda) => venda.produto, { onDelete: "RESTRICT", nullable: false })
  vendas: Venda[]
}
